...
public class PreparationPane extends BorderPane {
    ...
    private PreparationScreenPane getScreenPane() {
        if (screenPane == null) {
            screenPane = PreparationScreenPane.getInstance();
        }
        return screenPane;
    }
